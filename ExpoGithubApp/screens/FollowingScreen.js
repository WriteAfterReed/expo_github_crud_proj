...
class FollowerList extends React.Component {
    ...
    componentDidMount() {
        ...
        user_endpoint = user_endpoint.concat("/following");
    ...
    unfollow(user_name) {
      ...
      endpoint = "https://api.github.com/user/following/".concat(user_name);
      axios.delete(endpoint, config)
      .then(response => {
        console.log("Success");
        console.log("Unfollow Request succeded!");
        }) 
        .catch(error => {
        console.log(error);
    ...
    follow(user_name) {
      ...
      console.log("Success");
      console.log("Follow Request succeded!");
      }) 
      .catch(error => {
      console.log(error);
                ...
                ({item}) =>
                    <View style={styles.box}>
                        <View tyle={styles.button}>
                          <Button
                          title={"Following: ".concat(item.login)} 
                          onPress={  
                                  () => {
                        ...
                        <Button
                          title={"Unfollow: ".concat(item.login)} 
                          onPress={  
                                  () => {
                                    this.unfollow(item.login);
                                    this.forceUpdateHandler("");
                                  }
                              }
                          />
                        <Button
                          title={"Follow: ".concat(item.login)} 
                          onPress={  
                                  () => {
                                    this.follow(item.login);
                                    this.forceUpdateHandler("");
                                  }
                              }
                          />
